...
<template>
	<div class="relative">
		<input
			...
			class="w-full px-4 py-1.5 lg:py-2 rounded-md shadow-md bg-orange-100 dark:bg-[#B9B4C7] text-orange-600 dark:text-white placeholder-orange-300 dark:placeholder-white focus:outline-none focus:ring focus:ring-orange-300 dark:focus:ring-[#6b6a6e]"
			@click="toggle($event)"
		/>
