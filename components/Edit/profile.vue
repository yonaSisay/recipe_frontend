...
<template>
  <form
    ...
    class="w-full p-6 bg-white rounded-lg shadow-md mt-4"
  >
    <div class="mb-4">
    ...
    <div class="mb-4">
      <label class="block text-gray-700 text-sm font-bold" for="bio"
    ...
    <div>
      <button
        class="bg-orange-400 text-white py-2 ml-2 px-4 rounded-lg hover:bg-orange-600 focus:outline-none focus:bg-orange-600"
        :disabled="loading"
      >
