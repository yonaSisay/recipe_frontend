...
<template>
	<div class="flex h-screen items-center justify-center">
		<form
			...
			class="flex flex-col px-4 py-4 dark:bg-[#5C5470] bg-orange-400 w-[400px] h-auto rounded-2xl text-white shadow-2xl -rotate-3 hover:rotate-0 hover:scale-110 hover:-translate-y-1 duration-500"
		>
