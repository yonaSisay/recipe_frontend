...
<template>
	<div>
		<div
			class="flex items-center flex-col shadow-lg py-8 mb-2 bg-gradient-to-b from-orange-300 via-orange-400 to-orange-500 dark:from-[#5C5470] dark:to-[#352F44]"
		>
			<img
		...
		<section class="py-8 px-4 sm:px-6 lg:px-20">
			<h2
				class="text-2xl font-semibold text-orange-500 dark:text-white relative inline-block after:absolute after:content after:w-2/4 after:h-0.5 after:bottom-0 after:left-1/4 after:bg-orange-500 dark:after:bg-white after:rounded-lg after:transform after:-translate-x-1/4 after:transition-all after:duration-300"
			>
