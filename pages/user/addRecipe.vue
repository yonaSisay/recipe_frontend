<template>
	<div class="h-full px-8 py-8 mx-auto">
		<div class="flex justify-between">
			<h3
				for="Ingredient"
				class="block text-gray-700 dark:text-white dark:text-white text-3xl font-bold mb-2"
			>
				Add recipe
				<button
					@click="toggleMenu"
		...
		<form
			...
			action=""
			@click="restoreError"
			class="bg-white dark:bg-[#5C5470] rounded-lg shadow p-2 mt-8"
		>
					...
					<div>
						<div class="flex gap-x-2">
							...
							<button
								type="button"
								@click="openEditModal"
								class="w-full flex text-orange-700 dark:text-[#B9B4c7] text-sm font-bold"
							>
								New ingredient
							</button>
						...
						<button
							type="button"
							@click="addIngredient"
							class="flex text-orange-700 dark:text-[#B9B4c7] text-sm font-bold mb-2"
						>
							Add
						</button>
					</div>
				...
				<div class="md:w-[50%] flex flex-col">
					<div>
						<div class="flex gap-x-2 mb-2">
							...
							<button
								...
								class="flex text-orange-700 dark:text-[#B9B4c7] text-sm font-bold"
							>
								New category
							</button>
						...
						<button
							type="button"
							@click="addCategory"
							class="mb-2 flex text-orange-700 dark:text-[#B9B4c7] text-sm font-bold"
						>
							Add
						</button>
					</div>
					...
					<div>
						...
						<button
							type="button"
							@click="addSteps"
							class="flex text-orange-700 dark:text-[#B9B4c7] text-sm font-bold p-2"
						>
							Add
						</button>
					</div>
			...
			<div>
				...
				>
					...
					>
						<label
							class="flex flex-col w-full h-32 border-4 border-dashed hover:bg-gray-100 dark:hover:bg-[#B9B4c7]"
						>
							<div
			...
			<div class="flex justify-center">
				<button
					...
					type="submit"
					class="mt-2 dark:bg-[#B9B4C7] bg-orange-400 text-white font-semibold py-2 px-6 rounded-lg hover:bg-orange-600 focus:outline-none focus:bg-orange-600"
				>
